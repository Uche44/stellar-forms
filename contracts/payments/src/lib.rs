...
const NATIVE_TOKEN_CONTRACT_ID: &str = "CAS3J7ENGOSCH4OAHECDT57K7IO2412BY272252SUTSFY61HW3GQHJ2Y";
...
impl PaymentsContract {
    ...
    pub fn process_payment(
        ...
        let token_address = Address::from_string(&env, &String::from_str(&env, NATIVE_TOKEN_CONTRACT_ID));
